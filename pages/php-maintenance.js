...
export default function PHPMaintenance() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Maintenance Status - PHP Portal | Oceanview Apartments</title>
        <meta name="description" content="Check your maintenance request status using our PHP-powered portal" />
      </Head>
