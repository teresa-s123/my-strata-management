    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          {/* NEW PHP-powered maintenance status card */}
          <Link href="/php-maintenance">
            <a className={`${styles.card} ${styles.phpCard}`}>
              <h2>Status Check (PHP) &rarr;</h2>
              <p>Check the status of your maintenance requests using our PHP-powered portal.</p>
        ...
        {/* Optional: Add a quick navigation section */}
        <div className={styles.quickNav}>
          <h3>Quick Links</h3>
          <div className={styles.quickNavGrid}>
            <Link href="/maintenance">
              <a className={styles.quickNavLink}>Submit Maintenance Request</a>
            </Link>
            <Link href="/php-maintenance">
              <a className={styles.quickNavLink}>Check Request Status (PHP)</a>
            </Link>
            <a href="/contact" className={styles.quickNavLink}>Building Manager</a>
            <a href="/emergency" className={styles.quickNavLink}>Emergency Contact</a>
          </div>
        </div>
      </main>
      ...
      <footer className={styles.footer}>
        ...
        <p style={{ fontSize: '0.8em', marginTop: '0.5rem', opacity: '0.7' }}>
          Maintenance system powered by Next.js and PHP on Vercel
        </p>
      </footer>
    </div>
  );
